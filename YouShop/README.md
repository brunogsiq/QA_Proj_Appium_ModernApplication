# Desafio proposto pela Empresa YouShop ((https://www.youshop.com.br/))

# O mesmo encontra-se documentado separadamente dentros das pastads do projeto<br>
# poderão ser lidos separadamente dentro da pasta _Wiki e _ArtefatosDeTestes


<h2>Parte do conteúdo do projeto é contida pelas seguintes informações:

<h1>Este documento tem o intuíto de auxiliar a identificar quais testes deverão ser realizados;
